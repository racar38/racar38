...
public class C02_dependsOnMethods {
    ...
    @Test (dependsOnMethods = "amazonTest") // amazonTest calismadan ben calismam anlaminda
    ...
    @Test (priority = -1 , dependsOnMethods = "nutellaTest") // nutellaTest calismadan ben calismam anlaminda
    public void ilkUrunTesti(){

        Driver.getDriver().findElement(By.xpath("(//*[@class='a-section aok-relative s-image-square-aspect'])[1]"))
                .click();

        WebElement urunIsımElementi=Driver.getDriver().findElement(By.xpath("//span[@id='productTitle']"));
